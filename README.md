...
**Animus Amalgam is the self-improving AI agent, Hermes Agent, built by [Nous Research](https://nousresearch.com) with an adaptation of [Animus_Ferric's](https://github.com/crussella0129/Animus_Ferric) Constrained Decoding Core Module for better performance with small, locally running models.** 
