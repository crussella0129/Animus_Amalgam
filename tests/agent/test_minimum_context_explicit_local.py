...
def _build_custom_agent(cfg, probed_ctx=8192):
...
def test_pinned_local_window_without_auto_compression_is_admitted():
    ...
    assert agent.context_compressor.context_length == agent._config_context_length


def test_same_pin_with_auto_compression_still_hits_the_floor():
